...
#xgettext --language=Shell --add-comments=TRANSLATORS -o pot/$RESOURCE.pot ../base-mxfb/bin/appfinder-exit
xgettext --from-code=UTF-8 --language=Shell --add-comments=TRANSLATORS -o pot/$RESOURCE.pot appfinder-exit
